                            ...
                            <section className="space-y-6">
                                <div>
                                    ...
                                    <p className="mt-2 text-sm text-neutral-500">
                                        Generated using AI after static analysis.
                                    </p>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-8">
                                            ...
                                            <div className="mt-4 grid gap-3 sm:grid-cols-2">
                                                {snapshot.aiReview.strengths.map(
                                                    (strength) => (
                                                        <div
                                                            key={strength}
                                                            className="flex items-start gap-3 rounded-xl border border-emerald-300/15 bg-emerald-300/[0.05] p-4"
                                                        >
                                                            <div className="mt-1 flex size-5 items-center justify-center rounded-full bg-emerald-400/20 text-xs font-bold text-emerald-300">
                                                                ✓
                                                            </div>
                                        ...
                                        <div className="mt-8">
                                            ...
                                            <div className="mt-4 space-y-3">
                                                {snapshot.aiReview.refactoringPlan.map(
                                                    (step, index) => (
                                                        <div
                                                            key={`${index}-${step}`}
                                                            className="flex gap-4 rounded-xl border border-white/10 bg-white/[0.025] p-4"
                                                        >
                                                            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-violet-300/20 bg-violet-300/10 font-mono text-sm font-semibold text-violet-200">
                                                                {(index + 1)
                                                                    .toString()
                                                                    .padStart(2, "0")}
                                                            </div>
                                        ...
                                        {snapshot.aiReview.generatedDocumentation ? (
                                            <div className="mt-8">
                                                <p className="text-xs font-semibold uppercase tracking-[0.14em] text-violet-300">
                                                    Generated Documentation
                                                </p>

                                                <article className="mt-4 rounded-2xl border border-sky-300/20 bg-sky-300/[0.05] p-6">
                                        ...
                                        {snapshot.aiReview.findings.length > 0 ? (
                                            <div className="mt-8">
                                                <div>
                                                    <p className="text-xs font-semibold uppercase tracking-[0.14em] text-violet-300">
                                                        AI Findings
                                                    ...
                                                    <p className="mt-2 text-sm text-neutral-500">
                                                        Additional observations generated by AI beyond deterministic analysis.
                                                    </p>
                                                </div>

                                                <div className="mt-5 space-y-4">
                                                    {snapshot.aiReview.findings.map((finding) => (
                                                        <article
                                                            key={finding.id}
                                                            className="rounded-2xl border border-violet-300/15 bg-violet-300/[0.03] p-5"
                                                        >
