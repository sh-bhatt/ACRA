        ...
        <section className="py-20">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            ...
            <button
              type="button"
              disabled
              className="inline-flex h-12 cursor-not-allowed items-center rounded-xl bg-emerald-300 px-5 text-sm font-semibold text-emerald-950 opacity-50"
            >
              New review coming next
            </button>
          </div>
        </section>
      </div>
